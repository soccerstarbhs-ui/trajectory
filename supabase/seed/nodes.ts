...
export const nodes: SeedNode[] = [
  ...
  { key: "c_neurosci", type: "course", name: "PSYC UN2430 Cognitive Neuroscience", metadata: { credits: 3, dept: "Psychology" }, probability_impact: 1.5 },
  ...
  { key: "e_peerhealth", type: "extracurricular", name: "S-HEAL Volunteer Health Educator", metadata: { note: "Real: Students for Health Education, Access, and Literacy — formerly the Columbia chapter of Peer Health Exchange, now operates independently" }, probability_impact: 2 },
  ...
  { key: "cl_peerhealthexchange", type: "club", name: "S-HEAL (Students for Health Education, Access, and Literacy)", metadata: { note: "Real: independent student org, formerly the Columbia chapter of Peer Health Exchange; trains students to teach health ed in NYC high schools" }, probability_impact: 1 },
  ...
  { key: "i_surf", type: "internship", name: "Columbia SURF (Summer Undergraduate Research Fellowship)", metadata: { deadline: "January 2", duration: "10 weeks (May 26 – July 31, 2026)", note: "Real, Columbia-specific: Dept. of Biological Sciences, since the 1980s. Applications open Jan 2 of the year you'll conduct research." }, probability_impact: 6 },
